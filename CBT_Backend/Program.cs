...
//for sql server
builder.Services.AddDbContext<CBT_DbContext>(options =>
{
    options.UseSqlServer(builder.Configuration.GetConnectionString("CBT_AppCon"));
});
